...
async function main() {
  ...
  if (!saveDir) {
    console.error("No CK3 save dir found. Set CK3_SAVE_DIR.");
    process.exit(1);
  }
  ...
  const server = new McpServer(
    ...
    {
      instructions:
        "Tools report the player's CK3 realm from their latest save. Each response is stamped with the save's in-game date and age.",
    },
  );
